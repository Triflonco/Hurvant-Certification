...
import { ChevronRight, Award, ShieldAlert, Cpu, Eye, CheckCircle2, ArrowRight, AlertTriangle, Users } from 'lucide-react';
...
export default function HomeHero() {
  ...
  return (
    <>
      <PageMeta 
        title="HURVANT - Organismo Técnico de Certificación y Validación"
        description="Organismo Técnico de Conformidad especializado en la certificación de personas bajo UNE-EN ISO/IEC 17024 y adecuación de maquinaria según el Real Decreto 1215/1997."
        canonicalPath="/"
      />
      <div className="space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <Link to="/servicios/evaluacion-operativa" className="bg-white border border-slate-200/60 rounded-custom-md p-6 glass-card-hover block">
                ...
                <Link to="/sobre-hurvant" className="bg-white border border-slate-200/60 rounded-custom-md p-6 glass-card-hover block">
        ...
        {/* 3. PROPUESTA DE VALOR: EL VACÍO EN EL MERCADO */}
        ...
        {/* 4. FRASES ESTRATÉGICAS Y FILOSOFÍA DE MARCA */}
        ...
        {/* 5. REDIRECCIÓN A PILOTO (LLAMADA A LA ACCIÓN) */}
